...
// // video 1 --------------------------------------------------------------------------------------------
// `define VIDEO1_IN_YUV_RAW_FILE  "../../../../../SIM/data/288x208.yuv"
// `define VIDEO1_OUT_MPEG2_FILE   "../../../../../SIM/data/288x208.m2v"
// `define VIDEO1_XSIZE  288
// `define VIDEO1_YSIZE  208

// video 1 --------------------------------------------------------------------------------------------
`define VIDEO2_IN_YUV_RAW_FILE  "../../../../../SIM/data/exp_640x320.yuv"
`define VIDEO2_OUT_MPEG2_FILE   "../../../../../SIM/data/exp_640x320.m2v"
...
//// video 4 --------------------------------------------------------------------------------------------
//`define VIDEO4_IN_YUV_RAW_FILE  "./data/a_1920_1080_30fps.yuv"
//`define VIDEO4_OUT_MPEG2_FILE   "./data/a_1920_1072_30fps.m2v"
//`define VIDEO4_XSIZE  1920
//`define VIDEO4_YSIZE  1024
...
mpeg2encoder_roi #(
    ...
    .YL                 ( YL                  ),
    .VECTOR_LEVEL       ( 3                   ),
    .Q_LEVEL            ( 1                   ),   // motion vector range level, must be 1, 2, or 3. The larger the XL, the higher compression ratio, and the more LUT resource is uses.    // quantize level, must be 1, 2, 3 or 4. The larger the Q_LEVEL, the higher compression ratio and the lower quality.
    .Q_LEVEL_ROI (1),     // finer quantization for ROI (lower Q => higher quality)
    .Q_LEVEL_BG  (5),    // coarser quantization for background
    .ROI_X16_MIN (7),
    .ROI_X16_MAX (14),
    .ROI_Y16_MIN (7),
    .ROI_Y16_MAX (14)
...
//            4 : begin
//                fp_in  = $fopen(`VIDEO4_IN_YUV_RAW_FILE, "rb");
//                fp_out = $fopen(`VIDEO4_OUT_MPEG2_FILE , "wb");
//                xsize  = `VIDEO4_XSIZE;
//                ysize  = `VIDEO4_YSIZE;
//            end
        endcase
